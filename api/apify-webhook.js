export default async function handler(req, res) {
      ...
      for (var i = 0; i < posts.length; i++) {
              ...
              try {
                        ...
                        var content = (post.content || '').substring(0, 2000);
                        var cv = {
                                    text_mm39wj8z: name,
                                    text_mm39xss9: company,
                                    text_mm39q5ez: jobTitle,
                                    long_text_mm39azh6: content,
                                    text_mm39nkvy: getContact(post.content || ''),
      ...
      return res.status(200).json({ message: 'Done: ' + pushed + ' of ' + posts.length + ' pushed to Monday' });
}

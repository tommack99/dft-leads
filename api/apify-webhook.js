...
export default async function handler(req,res){
  ...
  function isBroadlyRelevant(text){
    ...
    const bad=["my game","our game","i made","we made","wishlist","steam page","steam demo","steam next fest","devlog","just launched my","just released my","how do i market","advice on marketing","unity ","unreal engine","godot","pixel art","game jam","looking for playtesters","looking for beta","looking for artists","looking for programmers","looking for developers","i am a creator","i make content","my youtube channel","my tiktok","my instagram","i'm a creator","im a creator"];

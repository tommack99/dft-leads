...
const jobPostings=["#imhiring","we're hiring","we are hiring","now hiring","currently hiring","apply here","apply now","apply via","send your cv","send your resume","send a cv","join our team","join our growing team","we are recruiting","we are seeking a","seeking a talented","seeking an experienced","position available","job opening","full-time role","part-time role","freelance role available","remote role","immediate joiner","immediate joiners","wfh opportunity","internship","intern role","freshers","fresher","0-1 year","0 to 1 year","based in india only","must be based in india","jaipur","gurgaon","bangalore","mumbai","delhi","hyderabad","pune","chennai","kolkata"];
...
const good=["looking for a talent agency","looking for an agency","need an agency","talent agency","find an agency","recommend an agency","need recommendations for","agency recommendations","looking for content creators","looking for influencers","looking for youtubers","looking for ugc","looking for creators","sourcing creators","sourcing influencers","creators needed","influencers needed","hiring content creators","casting call","we are looking for creators","we need creators","brand is looking","client is looking","looking to work with creators","looking to work with influencers","partnering with creators","uk creators","uk-based creators","uk influencers","uk youtubers","uk content creators","british creators","british influencers","british youtubers","us creators","us-based creators","us influencers","us youtubers","us content creators","american creators","american influencers","american youtubers","united states creators","north america creators","us gaming","us youtube","canada creators","canadian creators","canadian youtubers","australian creators","australian influencers","australian youtubers","au creators","new zealand creators","nz creators","paid campaign","paid opportunity","paid collab","paid collaboration","marketing budget","campaign budget","looking to spend","per post","per video","per integration","talent manager","talent managers","creator manager","influencer manager","reach out to streamers","reach out to youtubers","dm me if you","dm if you are a creator","dm us if","comment below if you","email me if you","get in touch if you","brand deal","sponsor","sponsorship","paid partnership","brand partnership","collab opportunity","collaboration opportunity","brand collab","creator campaign","influencer campaign","creator program","influencer program","ugc program","affiliate program","ambassador program","does this job even exist"];
...
function detectSource(post){
  ...
  for(var i=0;i<posts.length;i++){
    ...
    var colValues={text_mm39wj8z:name.substring(0,100),text_mm39q5ez:title.substring(0,200),text_mm3fkmwh:source,long_text_mm39azh6:text.substring(0,500),link_mm39r70s:{url:postUrl,text:"View Post"},text_mm39nkvy:contact,date_mm39nc42:{date:today}};
